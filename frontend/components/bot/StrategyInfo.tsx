  ...
  return (
    <div className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#333333] rounded p-5 flex flex-col">
      ...
      <div className="grid grid-cols-1 gap-y-4 flex-1">
        <div className="flex justify-between items-center border-b border-gray-200 dark:border-[#333333] pb-2 last:border-0">
          <span className="text-gray-500 text-sm font-medium">Logic</span>
          <span className="text-slate-900 dark:text-white text-sm font-bold text-right">
            Mean Reversion + <br />
            News Sentiment
          </span>
        </div>
        <div className="flex justify-between items-center border-b border-gray-200 dark:border-[#333333] pb-2 last:border-0">
          ...
          <span className="text-[#ff6a00] text-sm font-bold">Aggressive</span>
        </div>
        <div className="flex justify-between items-center border-b border-gray-200 dark:border-[#333333] pb-2 last:border-0">
        ...
        <div className="flex justify-between items-center border-b border-gray-200 dark:border-[#333333] pb-2 last:border-0">
          ...
          <span className="text-[#00ff41] text-sm font-bold tabular-nums">
            68.4%
          </span>
        </div>
        <div className="flex justify-between items-center border-b border-gray-200 dark:border-[#333333] pb-2 last:border-0">
        ...
        <div className="flex justify-between items-center pt-2">
          ...
          <div className="flex gap-1">
            <span className="bg-gray-100 dark:bg-[#333333] px-1.5 py-0.5 rounded text-[10px] text-gray-500 dark:text-gray-300">
              Politics
            </span>
            <span className="bg-gray-100 dark:bg-[#333333] px-1.5 py-0.5 rounded text-[10px] text-gray-500 dark:text-gray-300">
              Crypto
